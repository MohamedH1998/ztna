...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  useEffect(() => {
    const updatePath = () => {
      if (containerRef.current && fromRef.current && toRef.current) {
        ...
        if (straight) {
          ...
          // Boxy path with 90-degree angles
          const offsetY = startY + curvature;
          d = `M ${startX},${startY} L ${startX},${offsetY} L ${endX},${offsetY} L ${endX},${endY}`;
        } else {
    ...
    // Debounce resize observer to reduce recalculations
